...
NiMatrix33& __vectorcall NiMatrix33::FromEulerPRY(__m128 pry)
{
	__asm
	{
		andps	xmm0, PS_XYZ0Mask
...
NiMatrix33& __vectorcall NiMatrix33::FromEulerPRYInv(__m128 pry)
{
	__asm
	{
		andps	xmm0, PS_XYZ0Mask
...
NiMatrix33& __fastcall NiMatrix33::MultiplyMatrices(const NiMatrix33& matB)
{
	__asm
	{
		movups	xmm0, [edx]
...
NiMatrix33& __fastcall NiMatrix33::MultiplyMatricesInv(const NiMatrix33& matB)
{
	__asm
	{
		movups	xmm0, [edx]
